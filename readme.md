...
7. **Regolazione del Fattore di correzione:**
   - Il campo "% Fattore di correzione" nel foglio "Modulo in elaborazione" consente una regolazione fine dei canoni annui minimi e massimi (€/mq) all'interno delle fasce previste dagli accordi territoriali.
   ...
   **⚠️ Avvertenze:**
      - La modifica del campo "% Fattore di correzione" richiede attenzione e consapevolezza delle sue implicazioni. Alterare i valori minimi e massimi del canone annuo potrebbe comportare il superamento dei limiti imposti dagli accordi territoriali.
